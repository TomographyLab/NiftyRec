...
.2 Matlab         \DTcomment{\begin{minipage}[t]{7cm}
                  ...
                  The Matlab Toolbox is made up of mex extensions, m files and documentation. Subfolders of Matlab contain the m files 
...
.2 apps           \DTcomment{\begin{minipage}[t]{7cm}
                  ...
                  \end{minipage}}. 
.3 niftyrec\_gui   \DTcomment{\begin{minipage}[t]{7cm}
                  GTK based GUI for NiftyRec
                  \end{minipage}}. 
.2 doc           \DTcomment{\begin{minipage}[t]{7cm}
                  NiftyRec documentation.
                  \end{minipage}}. 
.2 nifti          \DTcomment{\begin{minipage}[t]{7cm}
                  Niftilib source code. Defines Nifti data structures and routines for IO of Nifti files. 
                  \end{minipage}}. 
