...
unsigned int ET_spherical_phantom(float *image_array, unsigned int *Nx, unsigned int *Ny, unsigned int *Nz, float *sizex, float *sizey, float *sizez, float *centerx, float *centery, float *centerz, float *radius, float *inner_value, float *outer_value)
{
    ...
    float pixdim_x = (*sizex)/(*Nx); float pixdim_y = (*sizey)/(*Ny); float pixdim_z = (*sizez)/(*Nz);
...
unsigned int ET_cylinders_ring_phantom(float *image_array, unsigned int *Nx, unsigned int *Ny, unsigned int *Nz, float *sizex, float *sizey, float *sizez, float *centerx, float *centery, float *centerz, float *ring_radius, float *length, float *min_cylinder_radius, float *max_cylinder_radius, unsigned int *N_cylinders, float *inner_value, float *outer_value, float *taper, unsigned int *ring_axis)
{
    unsigned int status=STATUS_SUCCESS;
    // Allocate the nifti image
    float pixdim_x = (*sizex)/(*Nx); float pixdim_y = (*sizey)/(*Ny); float pixdim_z = (*sizez)/(*Nz);
    ...
    // Make phantom
    status = et_cylinders_ring_phantom(phantomImage, *centerx, *centery, *centerz, *ring_radius, *length, *min_cylinder_radius, *max_cylinder_radius, *N_cylinders, *inner_value, *outer_value, *taper, *ring_axis);
